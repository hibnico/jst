...
public class PostListTemplateFactory {

    @Resource
    private CommonAnnotationBeanPostProcessor postProcessor;

    public PostListTemplate build(List<Post> posts, PostTemplate postTemplate) {
        PostListTemplate t = new PostListTemplate(posts, postTemplate);
