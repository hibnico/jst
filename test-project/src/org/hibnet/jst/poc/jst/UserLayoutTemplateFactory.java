...
public class UserLayoutTemplateFactory {

    @Resource
    private CommonAnnotationBeanPostProcessor postProcessor;

    public UserLayoutTemplate build(Template contentTemplate, User user) {
        UserLayoutTemplate t = new UserLayoutTemplate(contentTemplate, user);
