...
public class PageLayoutV2TemplateFactory {

    @Resource
    private CommonAnnotationBeanPostProcessor postProcessor;

    public PageLayoutV2Template build(User connectedUser, Template contentTemplate) {
        PageLayoutV2Template t = new PageLayoutV2Template(connectedUser, contentTemplate);
